...
## 筛选models
fs = dir2("Z:/ChinaHW/CMIP6_cluster_HItasmax_adjchunk/HI_tasmax_year/ssp585")
models <- get_model(fs, "_year_", "_ssp")
s_sel = s[model %in% models & grepl("r1i1p1f1", ensemble), ]

info3 = merge(info2, s_sel[, 1:3])

# save(info2, s, file = "info_prw.rda")
writeLines(info3$url, "urls_prw.txt")
```

```{julia}
using nctools

f = "esg_dataroot/CMIP6/CMIP/CMCC/CMCC-CM2-HR4/historical/r1i1p1f1/Eday/prw/gn/v20200904/prw_Eday_CMCC-CM2-HR4_historical_r1i1p1f1_gn_18500101-18591231.nc"

url = "http://esgf-data04.diasjp.net/thredds/dodsC/$f"
nc_open(url)

# http://esg.lasg.ac.cn/thredds/dodsC/esg_dataroot/CMIP6/CMIP/CAS/FGOALS-f3-L/historical/r1i1p1f1/day/pr/gr/v20191019/pr_day_FGOALS-f3-L_historical_r1i1p1f1_gr_18500101-18591231.nc
```
